...
- **This file is process evidence.** The harness built to direct the agent is
  itself read as part of how I worked. The gap between the starter's `AGENTS.md`
...
The starter shipped a `AGENTS.md` containing nothing but a note saying it was
